...
```
tar -zxvf apache-doris-2.1.6-bin-x64.tar.gz -C /usr/local/software/
ln -s /usr/local/software/apache-doris-2.1.6-bin-x64 /usr/local/software/doris
```
...
```
ALTER SYSTEM ADD FOLLOWER "192.168.1.132:9010";
ALTER SYSTEM ADD FOLLOWER "192.168.1.133:9010";
```
