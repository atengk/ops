...
```
helm pull bitnami/cert-manager --version 1.3.11
```
...
```
helm install cert-manager --create-namespace -n cert-manager -f values.yaml cert-manager-1.3.11.tgz
```
