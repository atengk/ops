...
docker.io/jumpserver/core:${version}
docker.io/jumpserver/koko:${version}
docker.io/jumpserver/lion:${version}
docker.io/jumpserver/chen:${version}
docker.io/jumpserver/web:${version}
EOF
```
...
```
registry_address="registry.lingo.local/jumpserver"
```
