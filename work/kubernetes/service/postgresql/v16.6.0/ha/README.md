...
```
kubectl run postgresql-client --rm --tty -i --restart='Never' --image  registry.lingo.local/bitnami/postgresql-repmgr:16.6.0 --namespace kongyu --env="PGPASSWORD=Admin@123" --command -- bash
```
