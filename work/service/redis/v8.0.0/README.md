...
- [编译软件包](/work/service/redis/v8.0.0/BUILD.md)
...
```bash
cp -r /usr/local/software/redis-8.0.0-openeuler /usr/local/software/redis-8.0.0
ln -s /usr/local/software/redis-8.0.0 /usr/local/software/redis
```
